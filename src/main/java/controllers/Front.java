    ...
    public VBox createMaisonBox(Maison maison) {
     ...
     //   ratingButton.getStyleClass().add("ratingButton");
        ...
        for (int i = 0; i < 5; i++) {
            ...
            star.setImage(new Image("empty_star.png"));
        ...
        for (int i = 0; i < ratingStars.size(); i++) {
            ...
            ratingStars.get(i).setOnMouseClicked(event -> {
                ...
                for (int j = 0; j < ratingStars.size(); j++) {
                    if (j < finalRating) {
                        ratingStars.get(j).setImage(new Image("star.png"));
                    } else {
                        ratingStars.get(j).setImage(new Image("empty_star.png"));
                    }
                }
            });
        }
        ...
        maisonBox.getChildren().addAll(imageView, nameLabel, typeLabel, adresseLabel, ratingStarsBox,qrCodeButton,addButton);
